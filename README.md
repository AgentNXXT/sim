...
The script builds `docker/app.Dockerfile` and `docker/realtime.Dockerfile`, pushes images to Artifact Registry, and deploys two Cloud Run services (`sim-app` and `sim-realtime`).
